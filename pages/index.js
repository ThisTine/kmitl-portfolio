...
export default function Home() {
  const weburl = "https://s.thistine.com/kmitl";
  return (
      ...
      <div className="bottom" style={{paddingBottom:"70px"}}>
        ...
        <div className="uniname">
          ...
          <div className="uniname-top">
            <p className="label uniname-label-name">Kmitl</p>
            <p className="label uniname-label-name">มหาวิทยาลัยลาดกระบัง</p>
          </div>
            <p className="label uniname-label">สาขาวิชาเทคโนโลยีสารสนเทศ</p>
          </div>
        </div>
