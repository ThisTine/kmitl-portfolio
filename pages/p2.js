          ...
          <div className="ab-bg shadow">
            ...
            <div className="ab-basic">
              ...
              <div style={{width:"70%"}}>
                ...
                <p className="ab-basic-text"> <span className="label ab-label">Dad</span>นาย xxxxx xxxxx</p>
                <p className="ab-basic-text"> <span className="label ab-label">Mom</span>นาง xxxxx xxxx</p>
                </div>
              <div style={{width:"30%"}}>
